...
socket.io.on('reconnect', () => {
    if (gameId && gameMode === 'multiplayer') {
        socket.emit('rejoin-game', { gameId, gameType: 'draughts' });
    }
});
socket.on('draughts-rejoined', (data) => { gameId = data.gameId; playerColor = data.color; console.log('Rejoined draughts:', gameId); });
